...
public static class NativeMethods
{
    ...
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_console_draw_rect_rgb(
        nint console,
        int x,
        int y,
        int width,
    ...
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_console_printn(
        nint console,
        int x,
        int y,
        nuint n,
    ...
    {
        using var scope = PrintInteropHelpers.CreatePrintParams(
            x: x,
            y: y,
            fg: fg,
            bg: bg,
        ...
        return PrintInteropHelpers.PrintnRgb(console, in scope.Value, str);
    }
    ...
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_console_flush_ex(nint console, nint viewport);

    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_console_flush();
    ...
    #region Context
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_context_new(in TCOD_ContextParams @params, out nint @out);

    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern void TCOD_context_delete(nint renderer);

    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_context_present(nint context, nint console, nint viewport);

    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_context_screen_pixel_to_tile_d(
        nint context,
        ref double x,
        ref double y
    );
    ...
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_context_screen_pixel_to_tile_i(
        nint context,
        ref int x,
        ref int y
    );
    ...
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_context_convert_event_coordinates(nint context, nint @event);

    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_context_save_screenshot(
        nint context,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string? filename
    );
    ...
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_context_change_tileset(nint self, nint tileset);

    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_context_get_renderer_type(nint context);

    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_context_recommended_console_size(
        nint context,
        float magnification,
        out int columns,
        out int rows
    ...
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_context_screen_capture(
        nint context,
        nint out_pixels,
        ref int width,
        ref int height
    ...
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_context_set_mouse_transform(nint context, nint transform);
    #endregion
    ...
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_image_save(
        nint image,
        [MarshalAs(UnmanagedType.LPUTF8Str)] string filename
    );
    ...
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_map_copy(nint source, nint dest);
    ...
    [DllImport(NativeLib, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    public static extern int TCOD_map_compute_fov(
        nint map,
        int pov_x,
        int pov_y,
        int max_radius,
